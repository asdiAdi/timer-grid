...
export function AnalogClock({ remainingMs, initialMs, status, label, locked, onPause, onSetRemaining }:{
  remainingMs: number;
  initialMs: number;
  status: string;
  label: string;
    ...
    <div className="flex flex-col items-center py-4">
      ...
      <div className="mt-2 font-mono text-sm tabular-nums text-zinc-400">
        <TimeSegments
          ...
          inputClassName="font-mono text-sm tabular-nums text-zinc-400"
        />
      </div>
    </div>
  );
